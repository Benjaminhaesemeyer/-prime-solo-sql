...
-- account balance of 0.00 and a transactions_attempted of 0. Give them
...
SELECT * FROM "syntax_practice" WHERE "account_balance" < 5000014 ORDER BY "account_balance" DESC LIMIT 3;
-- 6. Get the username and account balance of the 3 users with the lowest
-- balances, sort lowest to highest balance.
SELECT * FROM "syntax_practice" WHERE "account_balance" > 0 ORDER BY "account_balance" ASC LIMIT 3;
...
VALUES ('Benjamin', 'minneapolis', 10, 10, 1000000000.00);
